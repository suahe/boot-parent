package com.sah.gateway.config;

import com.sah.gateway.handler.HystrixFallbackHandler;
...
public class GatewayRoutersConfiguration {
    ...
    @Value("${gateway.route.config.data-id:#{null}}")
    public void setRouteDataId(String dataId) {
        DATA_ID = dataId + ".json";
    }

    @Value("${gateway.route.config.group:DEFAULT_GROUP:#{null}}")
    public void setRouteGroup(String routeGroup) {
        ROUTE_GROUP = routeGroup;
    }

    @Value("${gateway.route.config.data-type}")
